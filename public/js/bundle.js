      ...
      while (1) {
        switch (_context.prev = _context.next) {
          case 0:
            ...
            _context.prev = 1;
            _context.next = 4;
            return _axios.default.patch("http://localhost:3000/api/v1/users/".concat(endpoint), _objectSpread({}, data));
      ...
      return regeneratorRuntime.wrap(function _callee$(_context) {
        while (1) {
          switch (_context.prev = _context.next) {
            ...
            case 6:
              document.querySelector('.btn--save-data').innerHTML = 'Data saved';
      ...
      return regeneratorRuntime.wrap(function _callee2$(_context2) {
        while (1) {
          switch (_context2.prev = _context2.next) {
            ...
            case 7:
              document.querySelector('.btn--save-password').innerHTML = 'Password saved';
